...
*Note. All datasets described here were created using [these scripts](https://github.com/acastroaraujo/ccc/tree/master/data-raw), which use the functions described in the [search and download article](https://acastroaraujo.github.io/ccc/articles/search.html). See @denny2018 for an in-depth discussion of various pre-processing steps (e.g., removal of stop words, lemmatization, lowercasing).*
:::
