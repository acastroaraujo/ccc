...
write_rds(texto, "texto.rds", compress = "gz")
...
ggsave("lda_palabras.png", device = "png", dpi = "print", height = 5, width = 10)
...
ggsave("lda_sentencias.png", device = "png", dpi = "print", height = 5, width = 10)
